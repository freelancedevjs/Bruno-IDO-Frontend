  ...
  return (
    <>
      <div className=" flex flex-col items-center w-44 relative">
        ...
        <p className="text-primary text-sm text-center mt-8  md:mb-8 lg:mb-14 min-h-[80px]">
          {subtitle}
        </p>
        {buttonText &&
          link &&
...
const HowToParticipate: FC<HowToParticipateProps> = ({}) => {
  return (
    <div className="bg-gradient-1 bg-center bg-no-repeat w-full py-20 md:py-48 ">
